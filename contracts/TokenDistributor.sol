...
contract TokenDistributor{
    ...
    function setERC20Token (IERC20 tokenAddress) public {
        require(msg.sender == owner, "Only owner");
        ERC20Contract = IERC20(tokenAddress);
    }

    function updateClaimable (address receiver, uint ethAmt, uint erc20Amt) public payable {
        require(msg.sender == owner, "Only owner");
    ...
    function claim () public payable {
        require(claimableETH[msg.sender] > 0, "Invalid wallet address");
